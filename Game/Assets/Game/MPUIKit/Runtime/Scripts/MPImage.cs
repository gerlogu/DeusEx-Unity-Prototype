    ...
    public class MPImage : Image {
        ...
        public float ShapeRotation {
            ...
            set {
                ...
                if (m_Material == material) {
                    m_Material.SetFloat(SpShapeRotation, m_ShapeRotation * Mathf.Deg2Rad);
                }
        ...
        public override Material GetModifiedMaterial(Material baseMaterial) {
            ...
            if (baseMaterial.shader.name != MpShaderName) {
            ...
            if (DrawShape != DrawShape.None) {
                ...
                float pixelSize = Vector3.Distance(corners[1], corners[2]) / rt.rect.width;
                pixelSize /= FalloffDistance;
            ...
            mat.SetFloat(SpShapeRotation, m_ShapeRotation * Mathf.Deg2Rad);
        ...
        public void InitValuesFromSharedMaterial() {
            ...
            m_ShapeRotation = mat.GetFloat(SpShapeRotation) * Mathf.Rad2Deg;
